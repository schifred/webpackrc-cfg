...
exports.installDependencies = exports.install = undefined;
...
let install = exports.install = (() => {
  var _ref = _asyncToGenerator(function* (name) {
    ...
    if (!_fs2.default.existsSync(modulePath)) {
      ...
      const output = yield (0, _crossSpawn2.default)(npm, args, {
        stdio: 'inherit',
        cwd
      });
      console.info('Done');
...
let installDependencies = exports.installDependencies = (() => {
  var _ref2 = _asyncToGenerator(function* (installMode = 'dependencies') {
    // ctrl + c 退出
