...
function applyBasic(webpackConfig, options, context) {
  ...
  alias = _extends({
    "@babel/runtime-corejs2": _path2.default.resolve(__dirname, '../../node_modules/@babel/runtime-corejs2'),
    "@babel/plugin-transform-runtime": _path2.default.resolve(__dirname, '../../node_modules/@babel/plugin-transform-runtime')
  }, alias);
